...
int main(void)
{
	...
	LPCTSTR pszReportJson = TEXT("D:/Sample/xml/report.json"); // 본인 경로에 맞게 수정1
	LPCTSTR pszReportXml = TEXT("D:/Sample/xml/report.xml"); // 본인 경로에 맞게 수정2
	LPCTSTR pszTargetXml = TEXT("D:/Sample/xml/target.xml"); // 본인 경로에 맞게 수정3
	try
	{
